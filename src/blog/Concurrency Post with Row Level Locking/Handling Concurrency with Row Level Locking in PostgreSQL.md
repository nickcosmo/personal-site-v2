...
![Concurrency Problem Ladder Diagram](concurrency_ladder_diagram.png)
...
![Concurrency Solution Ladder Diagram](concurrency_ladder_diagram_after.png)
...
If you want to go further into this topic, check out some of the other features PostgreSQL has to offer, including table and page-level locks. You can read more about them in the documentation here: [13.3 - Explicit Locking](https://www.postgresql.org/docs/current/explicit-locking.html#EXPLICIT-LOCKING).
